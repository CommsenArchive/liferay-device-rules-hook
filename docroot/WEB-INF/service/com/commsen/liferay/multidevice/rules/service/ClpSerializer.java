...
import com.commsen.liferay.multidevice.rules.model.RuleClp;
...
public class ClpSerializer {
	...
	public static Object translateInput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(RuleClp.class.getName())) {
			RuleClp oldCplModel = (RuleClp)oldModel;
			...
			try {
				...
				try {
					Class<?> newModelClass = Class.forName("com.commsen.liferay.multidevice.rules.model.impl.RuleImpl",
							true, _classLoader);
					...
					Method method13 = newModelClass.getMethod("setAction",
							new Class[] { String.class });

					String value13 = oldCplModel.getAction();

					method13.invoke(newModel, value13);

					Method method14 = newModelClass.getMethod("setThemeId",
							new Class[] { String.class });

					String value14 = oldCplModel.getThemeId();

					method14.invoke(newModel, value14);

					Method method15 = newModelClass.getMethod("setColorSchemeId",
							new Class[] { String.class });

					String value15 = oldCplModel.getColorSchemeId();

					method15.invoke(newModel, value15);

					Method method16 = newModelClass.getMethod("setUrl",
							new Class[] { String.class });

					String value16 = oldCplModel.getUrl();

					method16.invoke(newModel, value16);

					Method method17 = newModelClass.getMethod("setPriority",
							new Class[] { Integer.TYPE });

					Integer value17 = new Integer(oldCplModel.getPriority());
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.commsen.liferay.multidevice.rules.model.impl.RuleImpl")) {
			ClassLoader contextClassLoader = Thread.currentThread()
												   .getContextClassLoader();
			...
			try {
				...
				try {
					...
					Method method13 = oldModelClass.getMethod("getAction");

					String value13 = (String)method13.invoke(oldModel,
							(Object[])null);

					newModel.setAction(value13);

					Method method14 = oldModelClass.getMethod("getThemeId");

					String value14 = (String)method14.invoke(oldModel,
							(Object[])null);

					newModel.setThemeId(value14);
					...
					newModel.setColorSchemeId(value15);

					Method method16 = oldModelClass.getMethod("getUrl");

					String value16 = (String)method16.invoke(oldModel,
							(Object[])null);

					newModel.setUrl(value16);

					Method method17 = oldModelClass.getMethod("getPriority");

					Integer value17 = (Integer)method17.invoke(oldModel,
							(Object[])null);

					newModel.setPriority(value17);
