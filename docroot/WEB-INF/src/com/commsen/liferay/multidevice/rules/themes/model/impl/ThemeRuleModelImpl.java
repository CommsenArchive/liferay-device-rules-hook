...
package com.commsen.liferay.multidevice.rules.themes.model.impl;

import com.commsen.liferay.multidevice.rules.themes.model.ThemeRule;
import com.commsen.liferay.multidevice.rules.themes.model.ThemeRuleModel;
import com.commsen.liferay.multidevice.rules.themes.model.ThemeRuleSoap;
...
/**
 * The base model implementation for the ThemeRule service. Represents a row in the &quot;MultiDevice_ThemeRule&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.commsen.liferay.multidevice.rules.themes.model.ThemeRuleModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ThemeRuleImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. All methods that expect a theme rule model instance should use the {@link com.commsen.liferay.multidevice.rules.themes.model.ThemeRule} interface instead.
 * </p>
 *
 * @author Milen Dyankov
 * @see ThemeRuleImpl
 * @see com.commsen.liferay.multidevice.rules.themes.model.ThemeRule
 * @see com.commsen.liferay.multidevice.rules.themes.model.ThemeRuleModel
 * @generated
 */
public class ThemeRuleModelImpl extends BaseModelImpl<ThemeRule>
	implements ThemeRuleModel {
	public static final String TABLE_NAME = "MultiDevice_ThemeRule";
	...
	public static final String TABLE_SQL_CREATE = "create table MultiDevice_ThemeRule (rid LONG not null primary key,companyId LONG,groupId LONG,layoutId LONG,brand VARCHAR(75) null,model VARCHAR(75) null,os VARCHAR(75) null,osVersion VARCHAR(75) null,browser VARCHAR(75) null,browserVersion VARCHAR(75) null,pointingMethod VARCHAR(75) null,tablet VARCHAR(75) null,qwertyKeyboad VARCHAR(75) null,themeId VARCHAR(75) null,colorSchemeId VARCHAR(75) null,priority INTEGER)";
	public static final String TABLE_SQL_DROP = "drop table MultiDevice_ThemeRule";
	public static final String ORDER_BY_JPQL = " ORDER BY themeRule.priority ASC";
	public static final String ORDER_BY_SQL = " ORDER BY MultiDevice_ThemeRule.priority ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.commsen.liferay.multidevice.rules.themes.model.ThemeRule"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.commsen.liferay.multidevice.rules.themes.model.ThemeRule"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.commsen.liferay.multidevice.rules.themes.model.ThemeRule"));
