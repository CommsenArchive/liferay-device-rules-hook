...
package com.commsen.liferay.multidevice.rules.themes.service.impl;
...
import com.commsen.liferay.multidevice.rules.themes.service.base.ThemeRuleLocalServiceBaseImpl;
import com.commsen.liferay.multidevice.rules.themes.service.persistence.ThemeRuleUtil;
 ...
 * {@link com.commsen.liferay.multidevice.rules.themes.service.ThemeRuleLocalService} interface.
 * </p>
 * 
 * <p>
 * Never reference this interface directly. Always use
 * {@link com.commsen.liferay.multidevice.rules.themes.service.ThemeRuleLocalServiceUtil} to access
 * the theme rule local service.
 * </p>
 * 
 * <p>
 ...
 * @see com.commsen.liferay.multidevice.rules.themes.service.ThemeRuleLocalServiceUtil
 */
public class ThemeRuleLocalServiceImpl extends ThemeRuleLocalServiceBaseImpl {
	...
	public List<ThemeRule> getRules(long companyId, long groupId) {
		...
		try {
			result = ThemeRuleUtil.findByGroup(companyId, groupId);
	 ...
	 */
	public List<ThemeRule> getRules(long companyId, long groupId, long layoutId) {
		List<ThemeRule> result = Collections.emptyList();
		try {
			result = ThemeRuleUtil.findByPage(companyId, groupId, layoutId);
		} catch (SystemException e) {
			_log.error("Failed to load theme rules!", e);
		}
		return result;
	 ...
	 */
	public List<ThemeRule> getMatchingRules(long companyId, long groupId, long layoutId, Device device) {
		List<ThemeRule> result = Collections.emptyList();
